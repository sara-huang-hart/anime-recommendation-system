...
- From the top 10 animes based on average user ratings (with a minimum of 1,000 ratings), we found that the year when the anime was released does not affect its popularity. As the table below shows, classic shows like <i>Gintama</i> (2015) and <i>One Piece</i> (1999) and newcomers such as <i>Shingeki no Kyojin</i> (2019) and <i>Sousou no Frieren</i> (2023) are equally highly rated.  
   <br>
...
6. We experimented with Z-score normalization to improve our model's performance and incorporated genres as dummy variables to give us more subtle results.  
   ...
   <br>  
7. Lastly, we initialized the nearest neighbors model on the new matrix data frame.  
   <br>
